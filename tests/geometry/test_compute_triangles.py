...
class TestComputeTriangles:
    ...
    def test_complex_triangulation(self):
        ...
        for triangle in result:
            assert 0 in triangle, f"Triangle {triangle} should contain center point"
            assert len(set(triangle)) == 3, f"Triangle {triangle} should have 3 unique vertices"
    ...
    def test_triangles_have_sorted_indices(self):
        ...
        for triangle in result:
            ...
            assert triangle == sorted_triangle, f"Triangle {triangle} should have sorted indices"
    ...
    def test_no_duplicate_triangles(self):
        ...
        assert len(set(result)) == len(result), "No duplicate triangles should be present"
    ...
    def test_square_no_internal_edges(self):
        ...
        assert result == [], "Square without internal edges should return empty triangles list"
    ...
    def test_result_is_sorted(self):
        ...
        assert result == sorted_result, f"Result should be sorted: {result} vs {sorted_result}"
    ...
    def test_large_triangulation(self):
        ...
        for triangle in result:
            assert center_idx in triangle, f"Triangle {triangle} should contain center point"
    ...
    def test_intersecting_edges_handled(self):
        ...
        assert len(result) > 0, "Should produce triangles when intersection is at existing point"
    ...
    def test_mixed_internal_and_boundary_edges(self):
        ...
        points = [Point(0, 0), Point(2, 0), Point(1, 2), Point(1, 1)]  # Triangle with internal point
        edges = [(0, 3), (1, 3), (2, 3)]  # Connect internal point to all boundary points
